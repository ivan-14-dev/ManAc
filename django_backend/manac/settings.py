...
MIDDLEWARE = [
    ...
    # Disable CSRF for API - using session auth with frontend
...
# Database
# For production (Vercel), use PostgreSQL
...
# Email settings
# Use SMTP backend when credentials are configured, otherwise fall back to console
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@manac.com')
